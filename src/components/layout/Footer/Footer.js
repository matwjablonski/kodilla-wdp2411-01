    ...
    <div className={styles.bottomBar}>
      <div className='container'>
        <div className='row align-items-center'>
          <div className='col-lg col-md-12 text-center'></div>
          <div className={'col-lg col-md-6 text-center ' + styles.copyright}>
            <p>©Copyright 2016 Bazar | All Rights Reserved</p>
          </div>
          <div className={'col-lg col-md-6 text-right ' + styles.socialMedia}>
            <ul>
              <li>
                <a href='#'>
